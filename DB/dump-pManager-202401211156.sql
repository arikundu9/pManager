...
-- Started on 2024-01-21 11:56:35 IST
...
--
-- TOC entry 4406 (class 1262 OID 17044)
...
--
-- TOC entry 4223 (class 2604 OID 17121)
-- Name: card order_value; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.card ALTER COLUMN order_value SET DEFAULT currval('public.card_id_seq'::regclass);


--
-- TOC entry 4224 (class 2604 OID 17073)
...
--
-- TOC entry 4226 (class 2604 OID 17074)
...
--
-- TOC entry 4228 (class 2604 OID 17120)
-- Name: list order_value; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.list ALTER COLUMN order_value SET DEFAULT currval('public.list_id_seq'::regclass);


--
-- TOC entry 4229 (class 2604 OID 17075)
...
--
-- TOC entry 4391 (class 0 OID 17046)
-- Dependencies: 214
...
--
-- TOC entry 4393 (class 0 OID 17051)
-- Dependencies: 216
-- Data for Name: card; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.card VALUES (2, '2024-01-21 11:41:32.809524', NULL, 2, NULL, 4, 2, 'card body');


--
-- TOC entry 4394 (class 0 OID 17055)
-- Dependencies: 217
...
--
-- TOC entry 4397 (class 0 OID 17061)
-- Dependencies: 220
...
INSERT INTO public.list VALUES (4, '2024-01-21 11:07:03.866535', NULL, 1, NULL, 14, 0, 'To Do                         ');
INSERT INTO public.list VALUES (5, '2024-01-21 11:18:15.658192', NULL, 1, NULL, 14, 5, 'done                          ');


--
-- TOC entry 4399 (class 0 OID 17066)
-- Dependencies: 222
-- Data for Name: user; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public."user" VALUES (2, '2024-01-21 11:40:09.857511', NULL, 0, NULL);
...
SELECT pg_catalog.setval('public.list_id_seq', 5, true);
...
--
-- TOC entry 4232 (class 2606 OID 17077)
...
--
-- TOC entry 4236 (class 2606 OID 17079)
...
--
-- TOC entry 4238 (class 2606 OID 17081)
...
--
-- TOC entry 4234 (class 2606 OID 17083)
...
--
-- TOC entry 4240 (class 2606 OID 17085)
...
--
-- TOC entry 4242 (class 2606 OID 17087)
...
--
-- TOC entry 4246 (class 2606 OID 17088)
...
--
-- TOC entry 4243 (class 2606 OID 17098)
...
--
-- TOC entry 4244 (class 2606 OID 17103)
...
--
-- TOC entry 4245 (class 2606 OID 17108)
...
--
-- TOC entry 4248 (class 2606 OID 17113)
...
-- Completed on 2024-01-21 11:56:35 IST
